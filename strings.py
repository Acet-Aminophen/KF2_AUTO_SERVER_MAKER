...
STR_LOG_SPLITTER = "--------------------------------------------------------------"
STR_LOG_PID = "PID : "
STR_LOG_BOOTING = "SERVER IS BOOTING..."
STR_LOG_ANNOUNCE_BOT_ONLINE = "KF2 SAM BOT ONLINE"
STR_LOG_REQUESTED_SERVER_STARTED = "SERVER STARTED : "
STR_LOG_DESTROY_SERVER = "DESTROY SERVER'S UUID : "
STR_SYS_SERVER_NAME_STARTS_WITH = "KF2SAM | "
